...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_cypher_start"));
...
//set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("sfx_cypher"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_SHAPE, 0); // 0 = circle, 1 = rectangle, 2 = rounded rectangle
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, -102);
...
set_hitbox_value(AT_USPECIAL, 1, HG_ANGLE, 45); //60
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_KNOCKBACK, 5); //6
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("sfx_hit_punch"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("ent_cypher"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_PLASMA_SAFE, false);
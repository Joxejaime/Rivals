...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_at_kick_02"));
...
set_hitbox_value(AT_USTRONG, 1, HG_SHAPE, 0); // 0 = circle, 1 = rectangle, 2 = rounded rectangle
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 78);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sfx_hit_punch_ko"));
//set_hitbox_value(AT_USTRONG, 1, HG_HITSTUN_MULTIPLIER, 2); // Edit this
//set_hitbox_value(AT_USTRONG, 1, HG_EXTRA_HITPAUSE, 10); // Edit this

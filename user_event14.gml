...
with phone{
	...
	APP_TIPS		= pho_initApp("Tips",			$188dd6, $000000, tips);
	APP_PATCHES		= pho_initApp("Patches",		$2ea995, $000000, patches);
	APP_DATA		= pho_initApp("Data",			$d69e1c, $000000, data);
	APP_CHEATS		= pho_initApp("Cheats",			$d61e1c, $000000, cheats);
	APP_UTILS		= pho_initApp("Utilities",		$5d18d6, $000000, utils);
	APP_POWER		= pho_initApp("Power",			$d6641c, $000000, []);
}
...
// CUSTOM INPUT
//=========================================================
var _strong_pressed = (right_strong_pressed || left_strong_pressed || up_strong_pressed || down_strong_pressed);
